...
var questions = [
    {
        "What country is generally acknowledged as the birthplace of wine?": [
            "Georgia",
            "Romania",
            "France",
            "England"
    ...
    {
        "The famous French wine Chablis is made from which grape variety?": [
            "Chardonnay",
            "Sauvignon blanc",
            "Pinot blanc",
            "Merlot"
    ...
    {
        "Approximately how old are the trees used for the best French barrels?": [
            "150 years old",
            "25 years old",
            "300 years old",
            "600 years old"
    ...
    {
        "Malolactic fermentation refers to which process?": [
    ...
    {
        "Chianti wines come from which region of Italy?": [
            "Tuscany",
            "Lombardy",
            "Piedmont",
            "Puglia"
    ...
    {
        "What puts the sparkle into sparkling wine?": [
            "carbon dioxide",
            "carbon monoxide",
            "sparkling water",
            "sodium crystals"
    ...
    {
        "Where is the Finger Lakes wine producing area?": [
            "New York state",
            "Washington State",
            "Switzerland",
            "Canada"
    ...
    {
        "A wine taster might say a wine has RS. What does RS stand for?": [
    ...
    {
        "What or who are Huxelrebe and Bacchus?": [
            "grape varieties",
            "gods of wine",
    ...
    {
        "The science of winemaking is known as what?": [
            "oenology",
            "wineology",
            "viticulture",
            "vinopoly"
    ...
    {
        "European vineyards are measured in hectares. How many acres to the hectare?": [
            "2.5 acres",
            "5 acres",
            "7 acres",
            "10.5 acres"
...
var ANSWER_COUNT = 4;
var GAME_LENGTH = 5;
var CARD_TITLE = "Wine Trivia"; // Be sure to change this for your skill.

function getWelcomeResponse(callback) {
    var sessionAttributes = {},
        speechOutput = "Wine trivia. I will ask you " + GAME_LENGTH.toString()
